...
export default function Maink() {
    ...
    const handleAddToCart = async () => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:3001/api/auth/login', { // Замените URL-адрес вашего бэкэнда
                mode: 'cors',
                method: 'POST',
                headers: {
    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.main2}>
                ...
                <div className={styles.text1}>Sign into your existing account to earn rewards, check existing orders and more</div>
                    <input
                        type="text"
                        placeholder="     Name"
                        value={username}
